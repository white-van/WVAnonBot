...
const errorMap = {
  ...
  1: new discord.MessageEmbed()
    ...
    .addFields({
      ...
      value:
        ...
        "**Monthly Special: Sad Stories Channel**\n" +
        "• `!sad (nsfw) your_message`\n" +
        "Description: Sends a message to the sad stories channel\n" +
        "Examples: !sad hello, !sad nsfw hello" ,
    })
    .setTimestamp(),
  // Rules for user
  ...
  // Sad Stories
  10000: "Sad stories channel set successfully :( Make sure the bot can actually see the channel in discord with its perms! (check the sidebar while in the channel. "
    + "If you see the bot, you're good. If not, give it perms in discord to be able to access it.)",
  11002: "Here's a sad story for you: the sad stories channel provided is an invalid channel :( "
};
